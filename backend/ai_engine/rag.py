...
def format_courses_for_prompt(matched_courses):
    ...
    for course in matched_courses:
        # Get first resource link for LLM prompt
        resources = course.get("resources", [])
        first_link = resources[0]["link"] if resources else "No link available"
        first_platform = resources[0]["platform"] if resources else "Online"
